...
T.RoundButton {
    ...
    background: Rectangle {
        ...
        color: control.down ? (Style.theme) ? Style.backColor3.darker(1.1) : Style.backColor3.lighter(1.1) : (control.highlighted || control.checked ? Style.backColor3.darker(1.1) : Style.backColor3)
